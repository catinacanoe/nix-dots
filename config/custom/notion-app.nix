# SOURCE: https://discourse.nixos.org/t/overrideattributes-for-a-new-notion-version/50334/4
{ appimageTools, lib, fetchurl }:
let
    pname = "notion-app";
    version = "3.12.2-1";
    # 3.12.2-1: sha256-QM5qcMOkMmxFcoqokcl5wxYTOHbYCfPkAU1iKtsQG68=
    # 3.12.1-1: sha256-WUKfYLmuRgdBRk+guGMyAy6PQnCopzOzj1E7IhVuXsA=
